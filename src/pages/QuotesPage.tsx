...
export function QuotesPage() {
  ...
  function getStatusBadge(status: string) {
    switch (status) {
      case 'draft':
        return <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-600"><Clock className="w-3 h-3" /> Draft</span>
      case 'sent':
        return <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-700"><FileText className="w-3 h-3" /> Sent</span>
      case 'accepted':
        return <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-700"><CheckCircle className="w-3 h-3" /> Accepted</span>
      case 'declined':
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-1">
                      <span className="font-mono font-medium text-magma">{quote.reference}</span>
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-600">
                      ...
                      {quote.project_name && (
                        <span className="text-gray-400">• {quote.project_name}</span>
                      )}
                      {!quote.client_name && !quote.project_name && (
                        <span className="text-gray-400 italic">No client details</span>
                      )}
                    </div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      <div className="text-lg font-bold text-gray-900">£{formatCurrency(quote.total)}</div>
